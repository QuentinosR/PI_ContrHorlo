 ...
 * Version 2.4.7
 * Bugfix Release:
 *   Bugfixed on camera get information functions to support strncpy for clang compiler
 *   Minor internal bugfixed
 *
 * Version 2.4.6
 * Bugfix Release:
 *   Improved packet resend mechanism
 *   Minor bugfixed 
 * 
 * Version 2.4.5
 * Bugfix Release:
 *   Cleanup unused resources in streaming channel
 *
 * Version 2.4.4
 * Bugfix Release:
 *   Minor changes on heartbeat mechanism
 *
 * Version 2.4.3
 * Bugfix Release:
 *   Bugfixed for Image_getImage12bitAs16bit()
 ...
 * Version 2.4.1
 * Bugfix Release:
 *   reconstruct the “gec” example to fix the issue from version 2.3.1.
 *
 * Version 2.4.0
 * function added:
